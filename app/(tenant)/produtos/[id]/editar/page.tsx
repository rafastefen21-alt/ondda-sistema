...
export default async function EditarProdutoPage({
  ...
  const productData = {
    ...
    qtdCaixa:      product.qtdCaixa     ?? null,
    ...
    stBcRetidoUnit:        product.stBcRetidoUnit        != null ? Number(product.stBcRetidoUnit)        : null,
    stAliquotaFinal:       product.stAliquotaFinal       != null ? Number(product.stAliquotaFinal)       : null,
    stValorSubstitutoUnit: product.stValorSubstitutoUnit != null ? Number(product.stValorSubstitutoUnit) : null,
    stIcmsRetidoUnit:      product.stIcmsRetidoUnit      != null ? Number(product.stIcmsRetidoUnit)      : null,
