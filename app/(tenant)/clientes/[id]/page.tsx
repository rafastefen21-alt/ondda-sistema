...
import { ArrowLeft, Mail, Phone, ShoppingBag, Calendar } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <Badge variant={client.active ? "success" : "secondary"} className="ml-auto">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="mt-1 text-sm font-medium text-gray-900">
              {client.orders[0]
                ? formatDate(client.orders[0].createdAt)
                : "Nenhum pedido"}
            </p>
          </CardContent>
        </Card>
